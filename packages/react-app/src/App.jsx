        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              ...
              {/* // NOTES: Fix color, add validation, make it pretty... */}
              <input style={{ color: "red", width: 50, textAlign: "center"}} type={("text")} id="amount" onChange={onEtherChange} ></input>
